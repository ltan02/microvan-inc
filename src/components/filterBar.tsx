        ...
        <div className="flex items-center h-full w-full mx-auto px-[32px]">
          <div className="flex w-full items-center">
            <div className="flex items-center">
              <button className="bg-white flex items-center justify-center w-[48px] h-[48px] p-[12px] border-none rounded-full hover:drop-shadow-lg transition">
                <FilterListIcon />
              </button>
            </div>
            <div className="w-[240px] ml-auto shrink-0">
              <div className="w-full m-0 p-0">
                <div className="w-auto h-[48px] flex items-center pl-[24px] pr-[20px] font-semibold text-[16px] hover:cursor-pointer p-[12px] rounded-[10px] border-2 border-[#e5e8eb]">
                  <input
                    placeholder="Sort by"
                    className="hover:cursor-pointer bg-transparent border-none outline-0 m-0"
                    aria-invalid="false"
                    readOnly
                    aria-haspopup="true"
                  />
